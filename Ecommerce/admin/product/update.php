 ...
 <div class="container">
    <div class="row">
        ...
        <form action="update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label class="form-label">Add Product KeyWords</label>
                <input type="text" value="<?php echo $data['PKey']?>" name="Pkey" class="form-control"  placeholder="Enter Product Price">
            </div>
...
if(isset($_POST['update']))
{
   ...
   include 'Config.php';
   mysqli_query($con,"UPDATE `tblproduct` SET `PName`='$product_name',`PPrice`='$product_price',`PKey`='$product_key',`Pimage`='$image_des',`PCategory`='$product_category' WHERE  id=$id");
