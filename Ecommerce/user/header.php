...
<div class="bg-danger sticky-top font-monospace d-flex ">
    ...
    <form action="search.php" method="POST" class="d-flex pl-10 " role="search" >
      <input class="form-control me-2 m-2 float-right" type="search" name="searchtext" placeholder="Search" aria-label="Search">
