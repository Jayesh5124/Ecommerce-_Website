        ...
        <div class="row">
            ...
            <form action="login1.php" method="POST">
                ...
                <div class="mb-3">
                 ...
                 <div class="mb-3">
                <button class="w-100 bg-danger border rounded-3 fs-4 text-white">LOGIN</button>
                 </div>

                 <div class="mb-3">
                <button name="submit" class="w-100 bg-warning border rounded-3 fs-4 text-white"><a href="register.php" class="text-decoration-none text-white">REGISTER</a> </button>
                 </div>
